...
import { addProduct, getProduct } from "../actions/productActions";
...
const AddProduct = () => {
  ...
  useEffect(() => {
    setimageSrc(dispatch(getProduct()));
  }, []);
  const categories = [
    "Freezed-Dried Meat",
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      console.log({ ...values, category, selectedFile });
  ...
  return (
    <div>
      <div className="container">
        <div className="row">
          <img src={`1707332618119-403441dfb1a26a9e82ae00863a663b92.jpg`}/>
